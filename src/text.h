...
#define ROOT_TEXT _("Please enter a password for the root user that is at least 6 characters long.\n")
#define NAME_ENTRY_TEXT _("Real Name")
#define USER_ENTRY_TEXT _("User Name")
#define USER_TITLE _("Initial User Setup")
#define USER_TEXT _("Please enter the information for an initial user.\nThe password must be at least 6 characters long.\n")
